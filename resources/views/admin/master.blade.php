    ...
    <div id="page-container" class="sidebar-o enable-page-overlay side-scroll page-header-fixed page-header-glass side-trans-enabled">
        ...
        <nav id="sidebar">
            ...
            <a class="link-effect font-w700" href="#">
                                <img id="mainLogo" width="100%" style="        max-width: 100px;" data-theme="light" src="{{url("assets/logo.svg")}}" class="h-full-w-auto" alt="Trunçgil Teknoloji">
                            </a>
        ...
        <header id="page-header">
            <div class="content-header">
                ...
                <div class="content-header-section">
					...
					<a href="{{ url('./') }}" target="_blank" class="btn btn-circle"><i class="fa fa-globe"></i> {{__('Back to Website')}}</a>
                   <button type="button" class="btn btn-circle btn-dual-secondary" data-toggle="layout"
